...
void strafe(double time, int direction) {
  drivetrain::drive_left_front.moveVelocity(200 * direction);
  drivetrain::drive_right_front.moveVelocity(-200 * direction);
  drivetrain::drive_right_back.moveVelocity(200 * direction);
  drivetrain::drive_left_back.moveVelocity(-200 * direction);
  pros::delay(time);
  drivetrain::drive_left_front.moveVelocity(0);
  drivetrain::drive_right_front.moveVelocity(0);
  drivetrain::drive_right_back.moveVelocity(0);
  drivetrain::drive_left_back.moveVelocity(0);
}
